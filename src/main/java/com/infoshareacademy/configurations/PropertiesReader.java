...
public class PropertiesReader {
    ...
    String propertiesFileName = "Java Resources/resources/formatsConfigurations.properties";

    // This method reads the keys from properties files and assigns them.
    ...
    public static String getSortCategory() {
        return sortCategory;
    }
